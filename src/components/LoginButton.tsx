  ...
  if (session) {
    ...
    const navLinks = (
      <>
        ...
        <button onClick={() => { setIsMobileMenuOpen(false); setIsTermsOpen(true); }} className="flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-red-50 text-red-700 hover:bg-red-100 hover:text-red-900 border border-red-200 transition whitespace-nowrap">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1.5 text-red-500">
      ...
      <>
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="xl:hidden text-gray-600 hover:text-brand-600 p-1 transition focus:outline-none"
            title="Menu"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              {isMobileMenuOpen ? (
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-16 left-0 w-full bg-white border-b border-gray-200 shadow-lg xl:hidden z-40">
