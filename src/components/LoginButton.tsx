        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-2 mr-4 border-r border-gray-200 pr-4">
            {roles.includes("admin") && (
              <Link href="/admin" className="flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-gray-50 text-gray-700 hover:bg-gray-100 hover:text-gray-900 border border-gray-200 transition">
            ...
            {roles.includes("market_owner") && (
              <Link href="/market-owner" className="flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-blue-50 text-blue-700 hover:bg-blue-100 hover:text-blue-900 border border-blue-100 transition">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1.5">
            ...
            {roles.includes("shop_owner") && (
              <Link href="/shop-owner" className="flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-purple-50 text-purple-700 hover:bg-purple-100 hover:text-purple-900 border border-purple-100 transition">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1.5">
            ...
            <Link href="/shopper" className="flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-brand-50 text-brand-700 hover:bg-brand-100 hover:text-brand-900 border border-brand-100 transition">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1.5">
